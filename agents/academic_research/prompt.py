...
tool based on the findings. Your final respose should be in poruguese BR, unless the user explicitly requests otherwise.
...
Ask the user if they would like to search for recent papers citing the seminal work.
If the user agrees:
    ...
    The agent will provide the answer and you should print it to the user.
